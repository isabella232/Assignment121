package com.niketgoel.assignment121;
...
public class SetpasswordActivity extends AppCompatActivity {
    ...
    /**
     * assigning Views and buttons to display result and perform actions by setting listeners
